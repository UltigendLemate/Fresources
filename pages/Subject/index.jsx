...
function Subject(props) {
    ...
    const buttons = Object.keys(topicsJSON).map((subject, index) => {
        return (
            <>
                <button onClick={() => setIsActive(subject)}
    ...
    return (
        <>
            ...
            <div
                style={{ width: props.shift, marginLeft: props.margin, transition: 'all 0.5s ease' }} className="min-h-screen max-h-auto items-center">

                <div className='mx-auto text-center pt-4 mb-2 md:pt-[3%] sm:mb-5 '>
                    ...
                    {topicsJSON[isActive].map((note, index) => {
                        return (
                            ...
                            <div
                                ...
                                drop-shadow-lg mx-auto md:max-w-screen-sm text-center text-md md:text-lg lg:text-xl  glass shadow-2xl

...
const contributors = () => {
    ...
    return(
        ...
        <h1 className='fresources text-5xl text-wide font-semibold'>Contributors </h1>



        <h1 className='text-xl text-wide text-center justify-center mx-6'>With immense support of our whole team, Fresources has been able to deliver you Quality content on-time, on-demand.</h1>

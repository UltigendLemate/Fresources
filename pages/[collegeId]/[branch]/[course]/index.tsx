...
function Index({ data, course }: Props) {
  ...
  return (
    <Layout className='text-white w-full py-8 flex flex-col gap-10 md:gap-8 items-center overflow-x-hidden'>
      ...
      <div className='w-full md:w-4/5 lg:2/3 px-8 justify-center items-center lg:truncate text-white grid grid-cols-1 pb-5 gap-5 md:grid-cols-3 xl:grid-cols-4'>
